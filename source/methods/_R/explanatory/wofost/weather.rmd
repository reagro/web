...
m <- matrix(c("variable", "description", "unit", "date", "Date class variable", "-", "srad", "Solar radiation", "kJ m-2 day-1", "tmin", "Minimum temperature", "°C", "tmax", "Maximum temperature", "°C", "vapr", "Vapor pressure", "kPa", "wind", "Wind speed", "m s-1", "prec", "Precipitation", "mm day-1"), ncol=3, byrow=TRUE)
knitr::kable(m)
```
