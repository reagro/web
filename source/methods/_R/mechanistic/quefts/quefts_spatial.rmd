...
We use soil raster data from [SoilGrids](https://soilgrids.org/). We changed the pH values from the original data source by dividing them by 10 to get the correct numbers.
