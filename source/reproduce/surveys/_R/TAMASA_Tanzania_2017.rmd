...
```{r getData}
library(agro)
ff2016 <- get_data_from_uri("https://data.cimmyt.org/dataset.xhtml?persistentId=hdl:11529/10548039", ".")
# note the more general url for the 2nd dataset. This will forward to
# https://data.cimmyt.org/dataset.xhtml?persistentId=hdl:11529/10548038
ff2017 <- get_data_from_uri("http://hdl.handle.net/11529/10548038", ".")
ff2016
ff2017
```
