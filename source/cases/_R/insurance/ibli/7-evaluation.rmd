...
First load mortality predictions data.
...
We now need to assess the welfare of index insurance to the pastoralists. So get the CE function.
...
From the plot you can observe that pastrolist with risk aversion less than 1.5 do not derive any value from the insurance. However, those with higher risk aversion derive more benefit from the insurance as the fall above the zero line.
