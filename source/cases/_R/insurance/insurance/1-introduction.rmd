...
Even if a program is well designed an insurance product may not be attractive to a household. It depends on how much production risk they are willing (or able) to take. Whether buying insurance is worth it for a household depends, among other things, on (a) how much they depend on the insured activity (do they have other sources of income); and (b) do the have other forms of insurance (for example, savings, or a community supports them when things get bad).
