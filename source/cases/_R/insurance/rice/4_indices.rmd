...
plot(v1, type = "l", col = "darkgreen", ylim = c(min(v1), max(v1)*1.25), 
      ylab = "EVI", xlab = "date", xaxt = "n", main = "EVI based index")
...
par(mfrow = c(1,2))
plot(arm[["idx_evi_v"]], main = "idx_evi_v", col=topo.colors(25))
plot(z, add = T)
plot(mzv, "idx_evi_v", main = "zone metrics", col=topo.colors(25))
```
